...
exports.AlphabetList = function (props) {
    var data = props.data, _a = props.index, index = _a === void 0 ? consts_1.DEFAULT_CHAR_INDEX : _a, style = props.style, indexLetterColor = props.indexLetterColor, _b = props.getItemHeight, onGetItemHeight = _b === void 0 ? function () { return sizes_1.sizes.itemHeight; } : _b, _c = props.sectionHeaderHeight, sectionHeaderHeight = _c === void 0 ? sizes_1.sizes.itemHeight : _c, _d = props.listHeaderHeight, listHeaderHeight = _d === void 0 ? sizes_1.sizes.listHeaderHeight : _d, _e = props.uncategorizedAtTop, uncategorizedAtTop = _e === void 0 ? false : _e, renderCustomSectionHeader = props.renderCustomSectionHeader, renderCustomItem = props.renderCustomItem, renderCustomListHeader = props.renderCustomListHeader, sectionListProps = __rest(props, ["data", "index", "style", "indexLetterColor", "getItemHeight", "sectionHeaderHeight", "listHeaderHeight", "uncategorizedAtTop", "renderCustomSectionHeader", "renderCustomItem", "renderCustomListHeader"]);
